...
//  Распыление аргументов ... - spread, распыление
// если элемент коллекции примитив - создается копия элемента,
// в случае сложного типа создается ссылка на оригинальный элемент.
const temper = [2, 3, 45, 32, 4, 56];
console.log(Math.max(...temper));

// Распыление массивов = это новый способ соединения с коллекцией элемента,
//     на смену concat

// const newTemperature = temper.concat([2, 4, 6, 3, 6]);
// то с помощью распыления массивов, мы делаем так

const newTemperature = [...temper, 2, 4, 6, 3, 6];
